...
module CacheHelper
  ...
  JQUERY_LIBRARY = {:name => 'jquery.all',
    :libs => %w(jquery jquery.cookie jquery.color jquery.bgiframe jquery.autocomplete jquery.jTagging jquery.jgrow jquery.cluetip ui.core ui.tabs ui.dialog ui.draggable jquery.fitimage jquery.iphone-style-checkboxes jquery.jeditable)}
