...
module Admin::ApplicationHelper
  ...
  def generate_admin_tab_menu
    ...
    output << generate_tab_link( _('Admin::DocumentsController'), edit_admin_tenant_document_path(current_tenant, Admin::Document::DOCUMENT_NAMES.first), request.url.include?(edit_admin_tenant_document_url(current_tenant, Admin::Document::DOCUMENT_NAMES.first)) )
