...
describe SiteCount do
  describe SiteCount, '.create_data' do
    it { pending '後で回帰テストを書く' }
  end

  describe SiteCount, '.calc_writer_at_month' do
    it { pending 'RSpec化する' }
#    # 一ヶ月以内に記事を書いたユーザ
...
#    end
  ...
  describe SiteCount, '.calc_user_access_at_month' do
    it { pending 'RSpec化する' }
...
#    end
  ...
  describe SiteCount, '.calc_user_access_at_month_only_weekday' do
    it { pending '後で回帰テストを書く' }
  end
